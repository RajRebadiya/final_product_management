...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Veer Creation | Dashboard</title>
    ...
    {{-- <link href="{{ asset('assets/css/dashboard.css') }}" type="text/css" rel="stylesheet" id="style-default"> --}}
                    ...
                    <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                        <li class="nav-item">
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <a class="nav-link dropdown-indicator label-1 theme-text" href="#" data-bs-toggle="collapse" data-bs-target="#offer-form-dropdown">
                                    <div class="d-flex align-items-center">
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="{{ route('dashboard') }}">
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center"><img
                                    src="{{ asset('assets/img/favicons/veer_logo_1.png') }}" alt="phoenix"
                                    height='55px' />
                                    ...
                                    <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar"
                                        ...
                                        <div class="row text-center align-items-center gx-0 gy-0">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!"><img
                                                        src="{{asset('assets/img/nav-icons/google-photos.webp')}}" alt=""
                                                        width="30" />
                                                    <p class="mb-0 text-body-emphasis text-truncate fs-10 mt-1 pt-1">
                                                        Photos</p>
                                                </a></div>
